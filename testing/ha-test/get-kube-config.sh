...
mkdir -p ~/.kube
ssh -i ~/.ssh/k8s_ansible_key ansible@192.168.122.107 "sudo cp /etc/kubernetes/admin.conf /home/ansible/config && sudo chown ansible:ansible /home/ansible/config"
scp -i ~/.ssh/k8s_ansible_key ansible@192.168.122.107:/home/ansible/config ~/.kube/config
